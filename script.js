...
let newCar = new Car("model", "doors", "color", "enginetype", "transmission", "trim", "wheelstrim", "audio", "seatstrim", "moonroof","enginesize", "navigation", "backupcamera", "warranty");
console.log(newCar)
...
class Sport extends Car {
  constructor(model, trim, transmission, top, color, seatstrim, audio, wheelstrim) {
    ...
    this.audio = audio;
    this.moonroof = false;
    this.engingetype = 'gasoline';
    this.convertible = true;
    this.doors = 2;
  }
}
let newSport = new Sport('model', 'trim', 'transmission', 'top', 'color', 'seatstrim', 'audio', 'wheelstrim', 'engingetype')
